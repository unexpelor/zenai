...
Dokumentasi lengkap tersedia di folder `doc/`:

- `doc/README.md` — peta dokumentasi
- `doc/01_USER_MANUAL.md` — panduan pengguna
- `doc/02_ARCHITECTURE.md` — arsitektur sistem
- `doc/03_FLOWCHART.md` — flowchart aplikasi
- `doc/04_SECURITY.md` — keamanan & privasi
- `doc/05_TESTING.md` — test plan & evidence
- `doc/06_DEPLOYMENT.md` — deployment checklist
- `doc/07_COMPETITION_DOCUMENTATION_CHECKLIST.md` — checklist dokumentasi lomba
- `doc/08_FAQ_TROUBLESHOOTING.md` — FAQ dan troubleshooting
- `doc/09_DEMO_GUIDE.md` — panduan demo
- `doc/10_FEATURE_REFERENCE.md` — referensi fitur
- `doc/11_DOCUMENTATION_INDEX.md` — indeks dokumentasi
- `doc/12_RELEASE_READINESS.md` — checklist kesiapan rilis/submission
