  ...
  try {
    ...
    if (body.action === "market-insight") {
      ...
      if (uniqueSources.length === 0) {
        return jsonError(
          requestedLocale === "en"
            ? "No external market sources were available, so an evidence-based market insight could not be generated."
            : "Tidak ada sumber pasar eksternal yang tersedia, sehingga wawasan pasar berbasis bukti belum dapat dibuat.",
          502,
          { "X-Market-Insight-Sources": "0" }
        );
      }
