...
export default function Home() {
  ...
  useEffect(() => {
    try {
      ...
      document.documentElement.dataset.zenaiTheme = darkMode ? "dark" : "light";
    } catch (error) {
...
`
  ...
  if (supabase && !authReady) {
    return (
      ...
      >
        <div style={{ color: darkMode ? darkMode ? "#475569" : "#cbd5e1" : "#64748b" }}>Memuat ZenAI...</div>
      </main>
    );
  }
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div style={{ color: darkMode ? darkMode ? "#475569" : "#cbd5e1" : "#64748b", marginBottom: "24px", lineHeight: "1.5" }}>
            {authMode === "login"
          ...
          {authMessage && (
            <div
              style={{
                marginTop: "14px",
                color: darkMode ? darkMode ? "#334155" : "#e2e8f0" : "#475569",
                fontSize: "14px",
                lineHeight: "1.5"
              }}
            >
  ...
  style={{
        "--zenai-bg": darkMode ? "#0b1120" : "#f8fafc",
        "--zenai-card": darkMode ? "#111827" : "#ffffff",
        "--zenai-soft": darkMode ? "#172033" : "#f1f5f9",
        flex: 1,
minWidth: 0,
overflowX: "hidden",
padding: isMobile ? "16px 12px" : "32px",
        minHeight: "100vh",
        background: "var(--zenai-bg)",
        color: darkMode ? "#e5e7eb" : darkMode ? "#f8fafc" : "#0f172a",
        display: "flex",
...
>
  ...
  style={{
    margin: "6px 0 0",
    color: darkMode ? darkMode ? "#475569" : "#cbd5e1" : "#64748b",
    fontSize: "13px",
    lineHeight: "1.5"
  }}
>
  ...
  color:
    tab === "home"
      ? "#2563eb"
      : darkMode ? darkMode ? "#334155" : "#e2e8f0" : "#475569",
      ...
      Strategi & Tindakan
        ...
        >
          <button
            ...
            title={sidebarOpen ? "" : (darkMode ? "Gunakan Tema Terang" : "Gunakan Tema Gelap")}
                            ...
                            <strong>
                              ...
                              style={{
                                margin:
                                  "6px 0",
                                color:
                                  darkMode ? darkMode ? "#475569" : "#cbd5e1" : "#64748b",
                                fontSize:
                                  "13px"
                              }}
                            >
                            ...
                            <span
                              style={{
                                fontSize:
                                  "12px",
                                color:
                                  darkMode ? darkMode ? "#475569" : "#cbd5e1" : "#94a3b8"
                              }}
                            >
                              {item.date}
                            </span>
  ...
  >
    ...
    {!marketLoading &&
      ...
      <style>{`
        ...
        /* Fallback for inline styles serialized as rgb(...) by the browser */
        ...
        .zenai-dark [style*="var(--zenai-card)"],
        .zenai-dark [style*="var(--zenai-card)"] {
          background: #111827 !important;
          color: #e5e7eb !important;
        }

        .zenai-dark [style*="var(--zenai-bg)"] {
          background: #0b1120 !important;
        }

        .zenai-dark [style*="var(--zenai-soft)"] {
          background: #172033 !important;
        }
        ...
        .zenai-dark [style*=darkMode ? "#334155" : "#e2e8f0"],
        .zenai-dark [style*="#e8edf3"],
        .zenai-dark [style*=darkMode ? "#475569" : "#cbd5e1"] {
          border-color: #334155 !important;
        }

        .zenai-dark [style*="#bfdbfe"] {
        ...
        .zenai-dark [style*="#fee2e2"],
        .zenai-dark [style*="#fecaca"] {
          border-color: #7f1d1d !important;
        }

        .zenai-dark [style*=darkMode ? "#f8fafc" : "#0f172a"] {
          color: #f8fafc !important;
        }

        .zenai-dark [style*=darkMode ? "#f1f5f9" : "#334155"] {
          color: #f1f5f9 !important;
        }

        .zenai-dark [style*=darkMode ? darkMode ? "#334155" : "#e2e8f0" : "#475569"] {
          color: #e2e8f0 !important;
        }

        .zenai-dark [style*=darkMode ? darkMode ? "#475569" : "#cbd5e1" : "#64748b"] {
        ...
        .zenai-dark button:not(.primary):hover {
