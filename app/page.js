    ...
    {[
      ...
      <button
        ...
        style={{
          width: "100%",
          minHeight: "43px",
          border: tab === key ? "1px solid #a7f3d0" : "1px solid #e8edf3",
          padding: "10px 12px",
          borderRadius: "10px",
          cursor: "pointer",
          display: "flex",
          ...
          background: tab === key ? (key === "health" ? "#ecfdf5" : "#ecfdf5") : "#ffffff",
          color: tab === key ? (key === "health" ? "#047857" : "#047857") : "#475569",
            ...
            >
              ...
              {tab === "health" && (
                <div style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
                  <div style={{ padding: "22px", borderRadius: "18px", border: `1px solid ${darkMode ? "#334155" : "#a7f3d0"}`, background: darkMode ? "#0f172a" : "#ecfdf5" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", gap: "14px", alignItems: "center", flexWrap: "wrap" }}>
                      <div><div style={{ fontSize: "20px", fontWeight: "800", color: darkMode ? "#f8fafc" : "#064e3b" }}>Live System Verification</div><div style={{ marginTop: "6px", color: darkMode ? "#cbd5e1" : "#065f46", fontSize: "14px", lineHeight: 1.5 }}>Pemeriksaan dilakukan saat tombol dijalankan dan hasil diberi timestamp.</div></div>
                      <button type="button" onClick={runLiveHealthCheck} disabled={healthLoading} style={{ border: "none", borderRadius: "10px", padding: "11px 16px", background: "#059669", color: "#fff", fontWeight: "800", cursor: healthLoading ? "wait" : "pointer" }}>{healthLoading ? "Memeriksa..." : "Run Live Health Check"}</button>
                    </div>
                  </div>
                  ...
                  {healthData && <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
                    <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(2, minmax(0, 1fr))", gap: "14px" }}>
                      {(healthData.services || []).map((service) => <div key={service.name} style={{ padding: "18px", borderRadius: "14px", border: `1px solid ${darkMode ? "#334155" : "#e2e8f0"}`, background: darkMode ? "#111827" : "#fff" }}><div style={{ display: "flex", justifyContent: "space-between", gap: "12px" }}><strong>{service.name}</strong><span style={{ fontWeight: "800", color: service.status === "operational" ? "#047857" : service.status === "configured" ? "#b45309" : "#be123c" }}>{service.status === "operational" ? "● OPERATIONAL" : service.status === "configured" ? "● CONFIGURED" : "● DOWN"}</span></div><div style={{ marginTop: "8px", color: darkMode ? "#cbd5e1" : "#64748b", fontSize: "13px", lineHeight: 1.5 }}>{service.detail}</div>{service.latencyMs != null && <div style={{ marginTop: "8px", fontSize: "12px", color: darkMode ? "#94a3b8" : "#64748b" }}>Latency: {service.latencyMs} ms</div>}</div>)}
                    </div>
                    {healthData.liveAiSmokeTest && <div style={{ padding: "18px", borderRadius: "14px", border: `1px solid ${darkMode ? "#334155" : "#e2e8f0"}`, background: darkMode ? "#111827" : "#fff" }}><div style={{ display: "flex", justifyContent: "space-between" }}><strong>Live AI Smoke Test</strong><span style={{ color: "#047857", fontWeight: "800" }}>● OPERATIONAL</span></div><div style={{ marginTop: "8px", fontSize: "13px", color: darkMode ? "#cbd5e1" : "#64748b" }}>Provider: {healthData.liveAiSmokeTest.provider} · Latency: {healthData.liveAiSmokeTest.latencyMs} ms · Response: {healthData.liveAiSmokeTest.response || "—"}</div></div>}
        ...
        {tab === "guide" && (() => {
          ...
          return (
            <div style={{ maxWidth: "1050px", display: "grid", gap: "18px" }}>
              ...
              >
                <div style={{ fontSize: "13px", fontWeight: "800", color: darkMode ? "#6ee7b7" : "#047857", letterSpacing: "0.04em" }}>
                  PANDUAN INTERAKTIF
                </div>
              ...
              <div
                style={{
                  background: darkMode ? "#172033" : "#ecfdf5",
              ...
              >
                <div>
                  <div style={{ fontSize: "12px", fontWeight: "800", color: darkMode ? "#6ee7b7" : "#047857", marginBottom: "5px" }}>
                    LANGKAH BERIKUTNYA
                  </div>
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "11px",
                    padding: "12px 18px",
                    background: nextStep.canOpen ? "#047857" : "#94a3b8",
                    color: "#ffffff",
                    fontWeight: "800",
                    ...
                    <div
                      ...
                      style={{
                        ...
                        background: step.done
                          ? (darkMode ? "#052e16" : "#ecfdf5")
                          : (darkMode ? "#111827" : "#f8fafc")
                      }}
                    >
                      <div style={{ width: "28px", textAlign: "center", fontWeight: "800", color: step.done ? "#059669" : "#64748b" }}>
                        {step.done ? "✓" : index + 1}
                      </div>
                        ...
                        {pulseData.positive.map(
                          (item, index) => (
                            <div
                              ...
                              style={{
                                background:
                                  darkMode ? "#0B3B2E" : "#ecfdf5",
                                border:
                                  darkMode ? "1px solid #065f46" : "1px solid #a7f3d0",
                                padding:
                                  "16px",
                                borderRadius:
                                  "12px"
                        ...
                        {diagnosis.problems.map(
                          (item, index) => (
                            <div
                              ...
                              style={{
                                border:
                                  darkMode ? "1px solid #7F1D1D" : "1px solid #fda4af",
                                background:
  ...
  <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
    ...
    {!marketLoading && !marketError && marketData && (
      <>
        ...
        >
          <div>
            <div style={{ fontSize: "12px", fontWeight: "800", color: "#047857", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: "5px" }}>
        ...
        {marketData.analysis && (
          <div style={{ display: "grid", gap: "14px", marginBottom: "22px" }}>
            <div style={{ background: darkMode ? "#111827" : "#FFFFFF", border: "1px solid #d1fae5", borderRadius: "18px", padding: "22px", boxShadow: "0 8px 24px rgba(37, 99, 235, 0.06)" }}>
              <div style={{ fontSize: "12px", fontWeight: "800", color: "#047857", textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: "8px" }}>🎯 Perspektif Utama</div>
...
>
  ...
  >
    {marketData.analysis.demandSignal?.reason || "Belum tersedia."}
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "14px" }}>
              <div style={{ background: "#ecfdf5", border: "1px solid #86efac", borderRadius: "16px", padding: "20px" }}>
                <div style={{ fontWeight: "800", color: "#047857", marginBottom: "10px" }}>💡 Peluang</div>
            ...
            {marketData.analysis.scenarios && (
              <div style={{ background: darkMode ? "#111827" : "#FFFFFF", border: "1px solid #e2e8f0", borderRadius: "18px", padding: "22px" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "12px" }}>
                  <div style={{ padding: "15px", borderRadius: "12px", background: darkMode ? "#064E3B" : "#ecfdf5", color: darkMode ? "#ecfdf5" : "#0F172A" }}><strong style={{ color: darkMode ? "#ecfdf5" : "#0F172A" }}>Optimistis</strong><p style={{ margin: "7px 0 0", lineHeight: "1.6", color: darkMode ? "#D1FAE5" : "#334155" }}>{marketData.analysis.scenarios.optimistic || "-"}</p></div>
                  <div style={{ padding: "15px", borderRadius: "12px", background: darkMode ? "#12372f" : "#ecfdf5", color: darkMode ? "#ecfdf5" : "#0F172A" }}><strong style={{ color: darkMode ? "#ecfdf5" : "#0F172A" }}>Realistis</strong><p style={{ margin: "7px 0 0", lineHeight: "1.6", color: darkMode ? "#d1fae5" : "#334155" }}>{marketData.analysis.scenarios.realistic || "-"}</p></div>
                  <div style={{ padding: "15px", borderRadius: "12px", background: darkMode ? "#78350F" : "#fffbeb", color: darkMode ? "#fffbeb" : "#0F172A" }}><strong style={{ color: darkMode ? "#fffbeb" : "#0F172A" }}>Risiko</strong><p style={{ margin: "7px 0 0", lineHeight: "1.6", color: darkMode ? "#fef3c7" : "#334155" }}>{marketData.analysis.scenarios.risk || "-"}</p></div>
                </div>
              </div>
            )}
            ...
            {Array.isArray(marketData.sources) && marketData.sources.length > 0 ? (
              marketData.sources.map((item, index) => (
                <div key={item.url || index} style={{ background: darkMode ? "#111827" : "#f8fafc", border: "1px solid #e2e8f0", borderRadius: "13px", padding: "16px" }}>
                  ...
                  {item.url && <a href={item.url} target="_blank" rel="noreferrer" style={{ color: "#047857", fontWeight: "700", textDecoration: "none" }}>Buka sumber ↗</a>}
                </div>
              ))
            ) : (
