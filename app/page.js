      ...
      >
        ...
        >
          ...
          <input
            ...
            autoComplete="email"
            style={{ width: "100%", padding: "12px", border: "1px solid #cbd5e1", borderRadius: "10px", marginBottom: "14px", boxSizing: "border-box" }}
          />
          ...
          <input
            ...
            style={{ width: "100%", padding: "12px", border: "1px solid #cbd5e1", borderRadius: "10px", marginBottom: "16px", boxSizing: "border-box" }}
          />
          <button
            type="submit"
            disabled={authLoading}
            style={{ width: "100%", padding: "13px", border: "none", borderRadius: "10px", background: "#2563eb", color: "#fff", fontWeight: "700", cursor: authLoading ? "not-allowed" : "pointer" }}
          >
            {authLoading ? "Memproses..." : authMode === "login" ? "Masuk" : "Buat Akun"}
          </button>
          {authMessage && (
            <div style={{ marginTop: "14px", color: "#475569", fontSize: "14px", lineHeight: "1.5" }}>
              {authMessage}
            </div>
          )}
          <button
            ...
            style={{ marginTop: "16px", border: "none", background: "transparent", color: "#2563eb", fontWeight: "600", cursor: "pointer", padding: 0 }}
          >
