  ...
  {sidebarOpen && (
    <span>
      Strategi & Tindakan
        ...
        {/* LIVE HEALTH CHECK */}
        <button onClick={() => setTab("health")} title={sidebarOpen ? "" : "System Health"} style={{ width: "100%", border: tab === "health" ? "1px solid #bbf7d0" : "1px solid #e8edf3", padding: "12px 14px", borderRadius: "10px", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: sidebarOpen ? "flex-start" : "center", gap: sidebarOpen ? "10px" : "0", textAlign: sidebarOpen ? "left" : "center", background: tab === "health" ? "#f0fdf4" : "#ffffff", color: tab === "health" ? "#15803d" : "#475569", fontWeight: tab === "health" ? "700" : "500", marginTop: "10px" }}>
          <span style={{ fontSize: "18px", flexShrink: 0 }}>♥</span>{sidebarOpen && <span>System Health</span>}
        </button>
