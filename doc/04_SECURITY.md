...
- Health Check bukan pengganti security test formal.
- API provider secret tidak boleh berada pada variable `NEXT_PUBLIC_*`.
- Dependency audit dan production build tetap harus dijalankan pada environment submission.
